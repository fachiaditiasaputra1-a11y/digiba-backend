...
app.listen(PORT, () => {
  console.log(` Backend server running on digiba-backend-production.up.railway.app${8080}`);
  console.log(` API endpoints available at digiba-backend-production.up.railway.app${8080}/api/*`);
  console.log(` Register: POST digiba-backend-production.up.railway.app${8080}/api/auth/register/vendor`);
});
